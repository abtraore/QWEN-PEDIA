...
class KVCacheCoordinator(ABC):
    ...
    def __init__(
        ...
        # BENCH ABLATION (vllm#53670): disable the EAGLE last-block drop
        # entirely. On hybrid layouts the drop cascades through the coarse
        # GDN-group alignment and costs ~1,600 tokens per warm prefix hit.
        # Env-gated so the same mounted file behaves stock when unset.
        import os as _os
        if _os.environ.get("VLLM_DISABLE_EAGLE_BLOCK_DROP") == "1":
