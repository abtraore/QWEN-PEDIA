...
FI_ALLREDUCE_FUSION_MAX_SIZE_MB: dict[int, dict[int, float]] = {
    ...
    # sm120 (consumer Blackwell, PCIe): rig patch, thresholds copied from sm100
    # as a starting point; no upstream entry exists so FI AR is refused for
    # every world size on cc 12.0 (the "not supported for world_size=N" log).
    120: {
        2: 64,
        4: 32,
        8: 1,
